...
import { X, Search as SearchIcon, Filter, Film, Calendar, Globe } from 'lucide-react';
import { useState, useMemo } from 'react';
import { RECOMMENDATIONS, GENRES, SERVICES, YEARS } from '../constants';
...
export default function SearchOverlay({ isOpen, onClose, onItemClick }: SearchOverlayProps) {
  ...
  const filteredResults = useMemo(() => {
    return RECOMMENDATIONS.filter(item => {
      ...
      return matchesSearch && matchesGenre && matchesService && matchesYear;
    });
  }, [searchTerm, selectedGenre, selectedService, selectedYear]);
          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12">
              ...
              <div className="space-y-10">
                ...
                {(selectedGenre || selectedService || selectedYear || searchTerm) && (
                  <button 
                    onClick={() => {
                    ...
                    {filteredResults.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black via-black/50 to-transparent">
                          <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-1">{(item as any).genre}</p>
