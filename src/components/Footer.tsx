      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-display font-bold text-xl tracking-tight">Ogle TV</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/40">
              ...
              <li><a href="#ogle-drop" className="hover:text-white transition-colors">Ogle Drop</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between gap-4">
          <p className="text-xs text-white/20">
            © 2026 Ogle TV. All rights reserved. Google TV is a trademark of Google LLC.
          </p>
